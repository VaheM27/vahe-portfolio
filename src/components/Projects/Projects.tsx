...
function SitePreview({ url, title, previewImage }: { url: string; title: string; previewImage?: string }) {
  ...
  return (
    <section id="projects" ref={ref} className={styles.projects}>
      <div className="container">
            ...
            >
              <div className={styles.cardVisual}>
                ...
                >
                  ...
                  <SitePreview url={project.liveUrl} title={project.title} previewImage={project.previewImage} />
                </div>
                <AnimatePresence>
                  {hovered === project.id && (
                    <motion.div
              ...
              <div className={styles.otherCardTop}>
                <div className={styles.folderIcon}>
                  <svg width="38" height="38" viewBox="0 0 40 40" fill="none">
                    <path d="M4 10C4 8.9 4.9 8 6 8h10l4 4h14c1.1 0 2 .9 2 2v16c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2V10z"
        ...
        >
          <a href={projects[0] && "https://github.com/VaheM27"} target="_blank" rel="noopener noreferrer" className={styles.viewMoreLink}>
            View GitHub Profile
